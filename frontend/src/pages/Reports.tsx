...
const Reports: React.FC = () => {
  ...
  const displayRole = useMemo(() => userRole.charAt(0).toUpperCase() + userRole.slice(1), [userRole]);
        ...
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Reports & Analytics</p>
            </div>
          </div>
